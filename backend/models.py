...
class Products(models.Model):
    ...
    warehouse_selejt_minimum_stock_quantity = models.FloatField(db_column='Warehouse___Selejt____Minimum_Stock_Quantity', blank=True, null=True)  # Field, blank=True, null=True)  # Fi, blank=True, null=True)  # Field name made lowercase. Field renamed because it contained more than one '_' in a row.
