    ...
    def post(self, request):
        ...
        for element in root.iter('ApiKey'):
            ...
            if api_key == os.environ.get("CLOUD_API_KEY"):
                ...
                print(response)
                return Response(data=response, status=HTTP_200_OK, headers={"cache-control": "no-cache, must-revalidate","cache-control":"max-age=604800", "access-control-allow-origin":"*","access-control-allow-headers":"Authorization","expires":"Sat, 23 Sep 2023 16:55:47 GMT","vary":"Accept-Encoding", "content-encoding":"gzip", "transfer-encoding":"chunked","content-type":"text/html; charset=UTF-8"})
